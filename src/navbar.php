            ...
            <ul class="navbar-nav">
                ...
                <a class="nav-link dropdown-toggle active" href="#" id="navbarDropdownMenuLink" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                        ...
                        <li><a class="dropdown-item" href="./test_list.php">Bài kiểm tra</a></li>
                ...
                echo "<div class='collapse navbar-collapse' id='navbarNavDropdown'>
                        <ul class='navbar-nav'>
                            <li class='nav-item dropdown'>
                                ...
                                <ul class='dropdown-menu' aria-labelledby='navbarDropdownMenuLink'>
                                    <li><a class='dropdown-item' href='./create_test.php'>Tạo bài kiểm tra</a></li>
                                    <li><a class='dropdown-item' href='./them_khoa_hoc.php'>Thêm khóa học</a></li>
                                </ul>
                            </li>
                        </ul>
                    </div>";
