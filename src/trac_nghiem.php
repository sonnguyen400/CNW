	...
	<main style="min-height: 100vh; max-width: 100%;">
            ...
            <div style="margin: 20px 13%;">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" value="<?php echo TRAC_NGHIEM_nDA?>" readonly  type="text" name="dang_cau_hoi" id="">
                </div>
                <div class="form-group">
                ...
                <?php
                    ...
                    for($i=0;$i<$defaultValue;$i++){
                        ...
                        echo "<div style='margin: 20px 0 0 0;' class='input-group mb-3'>   
                                <input type='checkbox' name='check$i' ".($isChecked).">
                ...
                <?php
                    if(isset($_POST["btn"])){
                        ...
                        for($i=0;$i<$defaultValue;$i++){
                            if(isset($_POST["da$i"])){
                                $count+=isset($_POST["check$i"])==true?1:0;
                                $da=Array(
                                    "ans"=>$_POST["da$i"],
